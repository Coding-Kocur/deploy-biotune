const products = [
    ...
    },
    {
        ...
        price: 249.00,
        stock: 30,
        description: 'SLU-PP-332 to syntetyczny agonista receptorów ERR (Estrogen-Related Receptor), który zwiększa liczbę mitochondriów i ich funkcję oksydacyjną. W badaniach na modelach mysich wykazuje zdolność do naśladowania efektów wysiłku fizycznego, poprawy wytrzymałości i metabolizmu kwasów tłuszczowych. Potencjalnie pomocny w badaniach nad otyłością i zespołem metabolicznym.',
        cas: '303760-60-3',
    ...
    },
    {
        ...
        price: 109.00,
        stock: 0,
        description: 'AOD9604 to zmodyfikowany fragment 176-191 ludzkiego hormonu wzrostu (hGH) z dodaną tyrozyną na N-końcu. Zaprojektowany, aby zachować właściwości lipolityczne hGH bez wpływu na wzrost i glikemię. W badaniach przedklinicznych stymuluje lipolizę (rozpad tłuszczu) i hamuje lipogenezę. Badany pod kątem otyłości i regeneracji tkanek chrzęstnych.',
        cas: '221231-10-3',
    ...
    },
    {
        ...
        price: 19.00,
        stock: 300,
        description: 'Woda bakteriostatyczna (BAC Water) to sterylna woda zawierająca 0,9% alkoholu benzylowego jako środek konserwujący. Zapobiega rozwojowi bakterii w roztworze, umożliwiając wielokrotne pobieranie z fiolki przez okres do 28 dni. Przeznaczona wyłącznie do celów badawczych i laboratoryjnych jako rozpuszczalnik do peptydów.',
        cas: null,
        molarMass: null,
        formula: null,
